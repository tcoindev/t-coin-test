...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "T-Coin"
!define MUI_FINISHPAGE_RUN $INSTDIR\T-Coin.exe
...
# Installer attributes
  OutFile T-Coin-v${VERSION}-win32-setup.exe
  !define VERSION_STRING ${VERSION}-win32
!if "32" == "64"
  InstallDir $PROGRAMFILES64\T-Coin
!else
  InstallDir $PROGRAMFILES\T-Coin
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "T-Coin"
VIAddVersionKey ProductVersion "${VERSION}"
VIAddVersionKey CompanyName "${COMPANY}"
VIAddVersionKey CompanyWebsite "${URL}"
VIAddVersionKey FileVersion "${VERSION}"

VIAddVersionKey FileDescription "T-Coin Installer v.${VERSION_STRING}"

VIAddVersionKey LegalCopyright "Copyright (c) 2014-2015 T-Coin Developers\n Copyright (c) 2014 BlackCoinDevelopers\n Copyright (c) 2011-2015 PPCoin Developers\n Copyright (c) 2009-2015 Bitcoin Developers"
...
Section -Main SEC0000
    ...
    SetOutPath $INSTDIR
    SetOverwrite on
    File /oname=T-Coin.exe ..\release\T-Coin-Qt.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\T-Coin.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\T-Coin.lnk"
